...
def handle_form():
    ...
    return {
        "k_numbers": [
            {
                "K": "K123456",
                "Device Description": "This is a device description",
                "Indication for Use": "This is an indication for use"
            },
            {
                "K": "K789012",
                "Device Description": "This is a device description2",
                "Indication for Use": "This is an indication for use2"
            }
        ],
        "comparison_table": [
            [
