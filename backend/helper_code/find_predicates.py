...
if __name__ == "__main__":
    ...
    list_comparisons = []
    for k_number in ['K201525', 'K221805']:
      comparison_table = get_final_comparison_table(k_number, "Comparison with Predicate Device", device_description, indications_for_use)
