...
function IntroForm(props: {
    ...
    return (
        <section id="intro-form" className="container mx-auto">
            <h1 className="text-center text-2xl">Enter details of your device</h1>
            <div className="w-1/2 mx-auto">
                <form onSubmit={props.onSubmit} id="info-form">
                    <div className="form-group my-6">
                        <label htmlFor="device-description" className="block font-medium mb-2 dark:text-white">
                            Device Description
                        </label>
                        <textarea
                            id="device-description"
                            name="device-description"
                            className="py-3 px-4 block w-full text-gray-500 border-gray-700 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                            rows={8}
                    ...
                    <div className="form-group my-6">
                        <label htmlFor="use-indication" className="block font-medium mb-2 dark:text-white">
                            Indication of use
                        </label>
                        <textarea
                            id="use-indication"
                            name="use-indication"
                            className="py-3 px-4 block w-full border-gray-700 text-gray-500 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" 
                            rows={8} 
                            placeholder="Say hi, we'll be happy to chat with you." 
                            aria-describedby="hs-textarea-helper-text"
